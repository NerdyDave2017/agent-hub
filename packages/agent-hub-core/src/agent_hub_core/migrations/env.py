"""
Alembic environment — wires migrations to the same SQLAlchemy `Base` as `agent_hub_core.db.models`.

Run from repo root (with Postgres up):
...
import agent_hub_core.db.models  # noqa: F401 — register all models on Base.metadata
